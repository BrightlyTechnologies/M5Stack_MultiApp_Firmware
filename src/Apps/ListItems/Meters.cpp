...
void plotNeedle(int value, byte ms_delay)
{
    ...
    while (!(value == old_analog))
    {
        ...
        M5.Lcd.drawLine(120 + 20 * ltx - 1, 140 - 20, ndlx - 1, ndly, TFT_WHITE);
        M5.Lcd.drawLine(120 + 20 * ltx, 140 - 20, ndlx, ndly, TFT_WHITE);
        M5.Lcd.drawLine(120 + 20 * ltx + 1, 140 - 20, ndlx + 1, ndly, TFT_WHITE);
        ...
        M5.Lcd.drawLine(120 + 20 * ltx - 1, 140 - 20, ndlx - 1, ndly, TFT_RED);
        M5.Lcd.drawLine(120 + 20 * ltx, 140 - 20, ndlx, ndly, TFT_MAGENTA);
        M5.Lcd.drawLine(120 + 20 * ltx + 1, 140 - 20, ndlx + 1, ndly, TFT_RED);
